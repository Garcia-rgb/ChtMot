...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='../models/mix_mot17_half_dla34.pth',
                                                     # '../exp/mot/mix_ft_ch_p4e8/model_40.pth',
                             help='path to pretrained model')
  ...
  def parse(self, args=''):
    ...
    opt.save_dir = os.path.join('/root/autodl-tmp/my_model_save', opt.exp_id)
